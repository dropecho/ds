...
namespace haxe {
	public class ValueException : global::haxe.Exception {
		...
		public ValueException(object @value, global::haxe.Exception previous, object native) : base(global::haxe.root.Std.@string(((object) (@value) )), ( (( previous == null )) ? (null) : (previous) ), ( (( native == null )) ? (null) : (native) )) {
			this.@value = @value;
		}
