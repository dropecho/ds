...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 109, 4745537, 5144726, 5343647, 5393365, 5442204, 5594513, 5741474, 57219237, 57476627, 76061764, 78945784, 87367608, 142301684, 221637784, 241646494, 312752480, 328878574, 359333139, 407283053, 452737314, 480756972, 501039929, 520590566, 572311959, 630156697, 746281503, 834174833, 863972113, 922671056, 946786476, 995006396, 1067353468, 1071652316, 1103412149, 1114204006, 1177754921, 1181037546, 1191633396, 1204816148, 1224901875, 1225394690, 1228056441, 1246881189, 1247875546, 1257164128, 1273207865, 1280549057, 1280845662, 1282943179, 1313416818, 1352786672, 1395555037, 1398464674, 1431819701, 1436822557, 1460447810, 1532710347, 1537812987, 1620824029, 1621420777, 1623148745, 1639293562, 1705629508, 1768617329, 1825849507, 1915412854, 1916009602, 1937159360, 2022294396, 2025055113, 2048392659, 2054707467, 2082663554, 2127021138};
		
		protected static string[] fields = new string[]{"i", "m", "__a", "get", "key", "len", "map", "pop", "set", "compare", "getEnumConstructs", "remove", "__previousException", "filter", "resize", "__nativeException", "distances", "get_native", "iterator", "lastIndexOf", "hasNext", "reverse", "nOccupied", "insert", "length", "native", "array", "contains", "value", "__nativeStack", "cachedIndex", "toString", "hashes", "splice", "exists", "copy", "dist", "__skipStack", "join", "keys", "concat", "next", "node", "enumConstructor", "path", "push", "keyValueIterator", "current", "size", "sort", "quicksort", "vals", "spliceVoid", "cachedKey", "getEnumName", "createEnumIndex", "createEnum", "__ownStack", "concatNative", "nBuckets", "__unsafe_get", "__unsafe_set", "indexOf", "lookup", "toDynamic", "allEnums", "unwrap", "__get", "__set", "__hx_deleteField", "upperBound", "unshift", "_keys", "enumParameters", "shift", "slice"};
